...
<body>
    <div class="page">
        ...
        {{-- ── Title ── --}}
        <div class="doc-title">Cash Advance Contract</div>
                        ...
                        <table style="width:100%; border-collapse:collapse;">
                            <tr>
                                ...
                                <td style="font-size:9pt; padding:1.5px 0;">
                                    <strong>{{ $kasbonContract->id_kasbon_cont ?? '-' }}</strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:8px; text-align:center; font-size:9pt; padding:1.5px 4px;">:</td>
                                <td style="font-size:9pt; padding:1.5px 0;">
                                    {{ $kasbonContract->tgl_kasbon ? $kasbonContract->tgl_kasbon->format('d M Y') : '-' }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:8px; text-align:center; font-size:9pt; padding:1.5px 4px;">:</td>
                                <td style="font-size:9pt; padding:1.5px 0;">
                                    {{ $kasbonContract->joContract ? $kasbonContract->joContract->no_jo_cont : '-' }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:8px; text-align:center; font-size:9pt; padding:1.5px 4px;">:</td>
                                <td style="font-size:9pt; padding:1.5px 0;">
                                    {{ $kasbonContract->joContract ? $kasbonContract->joContract->title : '-' }}
                                </td>
                            </tr>
                            <tr>
                    ...
                    <td style="width:50%; vertical-align:top; padding-left:100px;">
                        <table style="width:100%; border-collapse:collapse;">
                            <tr>
                                ...
                                <td style="width:8px; text-align:center; font-size:9pt; padding:1.5px 4px;">:</td>
                                <td style="font-size:9pt; padding:1.5px 0;">
                                    {{ $kasbonContract->departemen ? $kasbonContract->departemen->nama_dep : '-' }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:8px; text-align:center; font-size:9pt; padding:1.5px 4px;">:</td>
                                <td style="font-size:9pt; padding:1.5px 0;">
                                    {{ $kasbonContract->cabang ? $kasbonContract->cabang->nama_branch : '-' }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:8px; text-align:center; font-size:9pt; padding:1.5px 4px;">:</td>
                                <td style="font-size:9pt; padding:1.5px 0;">
                                    {{ $kasbonContract->release ? $kasbonContract->release->nama_release : '-' }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:8px; text-align:center; font-size:9pt; padding:1.5px 4px;">:</td>
                                <td style="font-size:9pt; padding:1.5px 0;">
                                    {{ $kasbonContract->tgl_release ? $kasbonContract->tgl_release->format('d M Y') : '-' }}
                                </td>
                            </tr>
                            <tr>
                                <td style="white-space:nowrap; font-size:9pt; padding:1.5px 0;">Area</td>
                                <td style="width:8px; text-align:center; font-size:9pt; padding:1.5px 4px;">:</td>
                                <td style="font-size:9pt; padding:1.5px 0;">
                                    {{ $kasbonContract->joContract && $kasbonContract->joContract->area
                                        ? $kasbonContract->joContract->area->area
                                        : '-' }}
                                </td>
                            </tr>
                        </table>
        ...
        {{-- ── Items Table ── --}}
        @php
            // lookup: id_jo_cont_item => KasbonContractItem
            $kasbonLookup = $kasbonContract->items->keyBy('id_jo_cont_item');

            // Sumber baris = seluruh JO Contract items (sama persis dengan $mergedItems di edit view)
