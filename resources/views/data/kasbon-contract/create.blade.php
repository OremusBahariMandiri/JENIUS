...
@push('styles')
<style>
    .kasbonContractCreatePage .card { border: none; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.08); }
    .kasbonContractCreatePage .card-header { border-radius: 10px 10px 0 0 !important; padding: 1rem 1.5rem; font-weight: 600; }
    .kasbonContractCreatePage .form-label { color: var(--text-dark); margin-bottom: 0.5rem; font-weight: 500; }
    .kasbonContractCreatePage .btn { border-radius: 8px; font-weight: 500; transition: all 0.2s; }
    .kasbonContractCreatePage .btn:hover { transform: translateY(-1px); box-shadow: 0 4px 8px rgba(0,0,0,0.1); }
    .kasbonContractCreatePage .btn-success { background-color: var(--primary-green); border-color: var(--primary-green); }
    .kasbonContractCreatePage .btn-success:hover { background-color: var(--dark-green); border-color: var(--dark-green); }
    ...
    .floating-badge-alert {
        ...
        animation: slideInRight 0.4s ease-out; backdrop-filter: blur(10px);
    }
    ...
    .add-item-form-section .form-select:focus { border-color: var(--primary-green); box-shadow: 0 0 0 0.3rem rgba(16,185,129,0.15); }
    .add-item-form-section .currency-group { display: flex; align-items: center; gap: 5px; }
    .add-item-form-section .currency-label {
        background-color: #2c3e50; color: white; border: 1px solid #2c3e50;
        padding: 0.6rem 0.75rem; font-size: 0.7rem; border-radius: 6px 0 0 6px;
        min-width: 50px; text-align: center; font-weight: 600;
    }
    .add-item-form-section .currency-input { border-radius: 0 6px 6px 0 !important; border-left: none !important; }
    ...
    .final-save-section {
        ...
        box-shadow: 0 -4px 20px rgba(0,0,0,0.1); border-radius: 12px 12px 0 0;
    ...
    .btn-final-back:hover { transform: translateY(-3px); box-shadow: 0 8px 25px rgba(49,49,49,0.5); color: white; }
    ...
    .jo-summary-divider {
        border-top: 1px solid #d1fae5; margin: 12px 0 0;
        padding-top: 12px; display: flex; gap: 28px; flex-wrap: wrap;
    }
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control fw-bold"
                                           value="{{ $previewNoKasbon }}" readonly
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select id="input_jo_cont_item" class="form-select">
                                        <option value="">-- Save header &amp; select JO Contract first --</option>
                                    </select>
...
$(document).ready(function () {
    ...
    $('#id_jo_cont').on('change', function () {
        ...
        if (!idJoCont) {
            joContractItems = [];
            $('#input_jo_cont_item').html('<option value="">-- Select JO Contract first --</option>');
    ...
    $(document).on('click', '#btnJoDetail', function () {
        ...
        $('#joItemsModalSubtitle').text(($opt.data('no') || idJoCont) + ' — ' + ($opt.data('title') || ''));
        ...
        success: function (response) {
            if (response.success) {
                ...
                response.data.forEach(item => {
                    options += `<option value="${item.id_jo_cont_item}">${item.invoice_typ} (${item.invoice_ctg})</option>`;
                });
...
$('#btnAddToTable').on('click', function () {
    ...
    if (!itemId)                          { showFloatingAlert('error', 'Please select a JO Contract Item'); return; }
