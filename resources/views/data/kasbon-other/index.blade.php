                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        @php
                            ...
                            $countUrgent   = $kasbonOthers->where('priority', 'urgent')->count();
                            $countHigh     = $kasbonOthers->where('priority', 'high')->count();
                            $countDueToday = $kasbonOthers->filter(
                                fn($k) => $k->due_date && $k->due_date->isSameDay($today) && !$k->due_date->lt($now)
                            )->count();
                            $countOverdue  = $kasbonOthers->filter(
...
@push('styles')
    ...
    <style>
        ...
        /* Priority row colors */
        .kasbonOtherPage table tbody tr.table-warning td { background-color: #fff3cd !important; }
        .kasbonOtherPage table tbody tr.table-success td { background-color: #d1fae5 !important; }
        .kasbonOtherPage table tbody tr.table-danger  td { background-color: #fee2e2 !important; }

        /* Override DataTables striped on colored rows */
        .kasbonOtherPage table.dataTable tbody tr.table-warning:hover td { background-color: #fde68a !important; }
        .kasbonOtherPage table.dataTable tbody tr.table-success:hover td { background-color: #a7f3d0 !important; }
        .kasbonOtherPage table.dataTable tbody tr.table-danger:hover  td { background-color: #fca5a5 !important; }
    </style>
@endpush
