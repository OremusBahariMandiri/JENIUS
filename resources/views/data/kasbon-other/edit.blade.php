            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header text-black d-flex justify-content-between align-items-center"
                        ...
                        <span class="fw-bold"><i class="fas fa-edit me-2"></i>Edit Cash Advance Other</span>
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <small class="text-muted mt-1 d-block"><i class="fas fa-info-circle me-1"></i>Changing
                                        the JO Other will reload the page to refresh items.</small>
                                </div>
    ...
    <script>
        ...
        function renderTable() {
            ...
            if (!mergedItems.length) {
                $tbody.html(
                    `<tr class="no-items-row"><td colspan="7"><i class="fas fa-inbox fa-3x d-block mb-3 text-muted opacity-50"></i><p class="mb-1 fw-bold">No items found for this JO Other</p></td></tr>`
                );
                updateFooter();
                return;
            }
            mergedItems.forEach(function(item, index) {
                ...
                $tbody.append(`
        <tr class="item-row" id="row_${index}" data-index="${index}" data-jo-item="${item.id_jo_other_item}">
                ...
                success: function(r) {
                    ...
                    if (r.success) {
                        ...
                        if (idJoOther != originalIdJoOther) {
                            showFloatingAlert('saving', 'JO Other changed — reloading...');
        ...
        $(document).ready(function() {
            ...
            function populateJoSummary(idJoOther) {
                ...
                const no = $opt.data('no') || idJoOther,
