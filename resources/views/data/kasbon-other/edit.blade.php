...
@section('title', 'Edit Cash Advance Other')
...
@section('content')
    ...
    <div class="container-fluid kasbonOtherEditPage">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header text-black d-flex justify-content-between align-items-center"
                        ...
                        <span class="fw-bold">
                            <i class="fas fa-edit me-2"></i>Edit Cash Advance Other
                        </span>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control fw-bold"
                                            value="{{ $kasbonOther->id_kasbon_other }}" readonly
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="tgl_kasbon" id="tgl_kasbon" class="form-control"
                                        value="{{ $kasbonOther->tgl_kasbon ? $kasbonOther->tgl_kasbon->format('Y-m-d') : '' }}"
                                        required>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="id_jo_other" id="id_jo_other" class="form-select select2-field" required>
                                        ...
                                        @foreach ($joOthers as $jo)
                                            <option value="{{ $jo->id_jo_other }}"
                                                ...
                                                data-note="{{ $jo->note ?? '' }}"
                                                {{ $kasbonOther->id_jo_other == $jo->id_jo_other ? 'selected' : '' }}>
                                    ...
                                    <small class="text-muted mt-1 d-block">
                                        ...
                                        Changing the JO Other will reload the page to refresh the items list.
                                    </small>
                                </div>
                                    ...
                                    <select name="id_md_dep" id="id_md_dep" class="form-select select2-field" required>
                                        ...
                                        @foreach ($departemens as $dep)
                                            <option value="{{ $dep->id_md_dep }}"
                                                {{ $kasbonOther->id_md_dep == $dep->id_md_dep ? 'selected' : '' }}>
                                                {{ $dep->nama_dep }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="id_md_cabang" id="id_md_cabang" class="form-select select2-field" required>
                                        ...
                                        @foreach ($cabangs as $cabang)
                                            <option value="{{ $cabang->id_md_branch }}"
                                                {{ $kasbonOther->id_md_cabang == $cabang->id_md_branch ? 'selected' : '' }}>
                                                {{ $cabang->nama_branch }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="id_md_release" id="id_md_release" class="form-select select2-field" required>
                                        ...
                                        @foreach ($releases as $rel)
                                            <option value="{{ $rel->id_md_release }}"
                                                {{ $kasbonOther->id_md_release == $rel->id_md_release ? 'selected' : '' }}>
    ...
    <script>
        ...
        function saveItemInput() {
            ...
            $.ajax({
                ...
                data: JSON.stringify({ items: [{ id_jo_other_item: joTramItemId, nilai_kasbon: nilaiKasbon }], _token: csrfToken }),
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        if (idJoOther != originalIdJoOther) {
        ...
        $(document).ready(function () {
            ...
            populateJoSummary($('#id_jo_other').val());
