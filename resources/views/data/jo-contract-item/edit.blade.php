...
@section('title', 'Edit JO Contract Item')

@section('content')
<div class="container-fluid">
    <!-- Page Header -->
    <div class="mb-4">
        <h1 class="h3 mb-2 text-gray-800">Edit JO Contract Item</h1>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header bg-white">
                    <h5 class="mb-0">Edit JO Contract Item Form</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('jo-contract-item.update', $joContractItem->id_jo_cont_item) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="id_jo_cont" class="form-select @error('id_jo_cont') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $joContract->id_jo_cont }}" {{ old('id_jo_cont', $joContractItem->id_jo_cont) == $joContract->id_jo_cont ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="id_md_invoice" class="form-select @error('id_md_invoice') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $invoice->id_md_invoice }}" {{ old('id_md_invoice', $joContractItem->id_md_invoice) == $invoice->id_md_invoice ? 'selected' : '' }}>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="pendapatan_idr" class="form-control @error('pendapatan_idr') is-invalid @enderror" value="{{ old('pendapatan_idr', $joContractItem->pendapatan_idr) }}" step="0.01" min="0">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="pendapatan_usd" class="form-control @error('pendapatan_usd') is-invalid @enderror" value="{{ old('pendapatan_usd', $joContractItem->pendapatan_usd) }}" step="0.01" min="0">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="kurs_usd" class="form-control @error('kurs_usd') is-invalid @enderror" value="{{ old('kurs_usd', $joContractItem->kurs_usd) }}" step="0.0001" min="0">
                                @error('kurs_usd')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="date" name="tgl_kurs_usd" class="form-control @error('tgl_kurs_usd') is-invalid @enderror" value="{{ old('tgl_kurs_usd', $joContractItem->tgl_kurs_usd ? $joContractItem->tgl_kurs_usd->format('Y-m-d') : '') }}">
                                @error('tgl_kurs_usd')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" name="hpp_ops" class="form-control @error('hpp_ops') is-invalid @enderror" value="{{ old('hpp_ops', $joContractItem->hpp_ops) }}" step="0.01" min="0">
                                    @error('hpp_ops')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" name="hargajual_idr" class="form-control @error('hargajual_idr') is-invalid @enderror" value="{{ old('hargajual_idr', $joContractItem->hargajual_idr) }}" step="0.01" min="0">
                                    @error('hargajual_idr')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
