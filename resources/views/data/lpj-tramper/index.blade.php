                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if(auth()->check() && (auth()->user()->is_admin || auth()->user()->hasAccess('lpj-tramper', 'detail')))
                                                <a href="{{ route('lpj-tramper.export-pdf', $lpj->id) }}" target="_blank"
                ...
                <form id="filterForm" method="GET" action="{{ route('lpj-tramper.index') }}">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select select2-filter" name="id_jo_tram"
                                id="filterJoTram" data-placeholder="-- Select JO Tramper --">
                                <option value=""></option>
...
@push('styles')
    ...
    <style>
        ...
        .lpjTramperPage .card { border: none; border-radius: 10px; }
        .lpjTramperPage .card-header { border-radius: 10px 10px 0 0 !important; padding: 1rem 1.5rem; }
        .lpjTramperPage .dataTables_wrapper { width: 100%; transition: all 0.3s ease; }
        .lpjTramperPage .dataTables_wrapper .dataTables_length,
        .lpjTramperPage .dataTables_wrapper .dataTables_filter { margin-bottom: 1rem !important; }
        .lpjTramperPage .dataTables_wrapper .dataTables_filter { text-align: right !important; }
        ...
        .lpjTramperPage #lpjTramperTable { width: 100% !important; transition: all 0.3s ease; }
        .lpjTramperPage #lpjTramperTable tbody tr { transition: all 0.2s ease; }
        .lpjTramperPage #lpjTramperTable tbody tr:hover { background-color: #f8f9fa; }
        .lpjTramperPage .btn-sm { transition: transform 0.2s; }
        .lpjTramperPage .btn-sm:hover { transform: scale(1.1); }
        .lpjTramperPage .table-responsive { width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch; }
        .lpjTramperPage .badge { font-weight: 500; padding: 0.35rem 0.65rem; }
    </style>
@endpush
