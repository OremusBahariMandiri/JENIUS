...
@push('styles')
    <style>
        ...
        .input-item-card .card-title-bar {
            ...
            margin-bottom:20px; padding-bottom:14px; border-bottom:1px solid #bbf7d0;
        }
        ...
        .info-field { background:white; border:1px solid #e5e7eb; border-radius:8px; padding:10px 14px; }
        ...
        .currency-group .currency-label {
            ...
            padding:0 14px; font-size:0.7rem; border-radius:8px 0 0 8px;
        ...
        .btn-save-item-input {
            ...
            box-shadow:0 4px 12px rgba(16,185,129,0.35); transition:all 0.25s;
        }
        .btn-save-item-input:hover { transform:translateY(-1px); box-shadow:0 6px 18px rgba(16,185,129,0.45); color:white; }
        ...
        .table-kasbon tbody td { border:1px solid #dee2e6; padding:10px 12px; vertical-align:middle; font-size:0.875rem; background-color:#fff; }
        ...
        .footer-value { color:#2C3E50; font-weight:700; font-size:.95rem; text-align:right; flex:1; }

        .btn-edit-row {
            background-color:#10b981; border-color:#10b981;
            padding:0.3rem 0.6rem; font-size:0.8rem; border-radius:6px; transition:all 0.2s;
        }
        .btn-edit-row:hover { background-color:#059669; border-color:#059669; transform:scale(1.08); }
        ...
        .final-save-section {
            position:sticky; bottom:0; background:white; padding:18px 20px;
        ...
        .jo-summary-card {
            ...
            border-radius:12px; padding:1.25rem 1.5rem; transition:all 0.3s;
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header text-black d-flex justify-content-between align-items-center"
                        ...
                        <span class="fw-bold">
                            <i class="fas fa-edit me-2"></i>Edit Cash Advance Tramper
                        </span>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="id_jo_tram" id="id_jo_tram" class="form-select select2-field" required>
                                        ...
                                        @foreach ($joTrampers as $jo)
                                            <option value="{{ $jo->id_jo_tram }}"
                                                ...
                                                data-start="{{ optional($jo->date_start)->format('Y-m-d') ?? '' }}"
                                                data-end="{{ optional($jo->date_end)->format('Y-m-d') ?? '' }}"
                                    ...
                                    <small class="text-muted mt-1 d-block">
                                        ...
                                        Changing the JO Tramper will reload the page to refresh the items list.
                                    </small>
                                </div>
                                ...
                                <div class="col-md-12" id="joSummaryWrapper" style="display:none;">
                                    <div class="jo-summary-card">
                                        ...
                                        <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:14px 24px;">
                                            ...
                                            <div>
                                                <div class="jo-meta-label">Vessel</div>
                                                <div class="jo-meta-value" id="joSummaryVessel"></div>
                                            </div>
                                            <div>
                                            ...
                                            <div>
                                                <div class="jo-meta-label">TA — TD</div>
                                                <div class="jo-meta-value" id="joSummaryDateRange"></div>
                                            </div>
                                            <div>
    ...
    <script>
            ...
            items.forEach(function (item, idx) {
                ...
                rows += `
                    <tr>
                        ...
                        <td style="font-weight:600;">${item.invoice_typ || item.id_jo_tram_item}</td>
                        <td>
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        if (idJoTram != originalIdJoTram) {
                            showFloatingAlert('saving', 'JO Tramper changed — reloading page...');
        ...
        $(document).ready(function () {
            ...
            function populateJoSummary(idJoTram) {
                ...
                $('#joSummaryNo').text($opt.data('no') || idJoTram);
                $('#joSummaryNo2').text($opt.data('no') || idJoTram);
                ...
                const start = formatDate($opt.data('start')), end = formatDate($opt.data('end'));
                $('#joSummaryDateRange').text(start !== '—' || end !== '—' ? start + ' — ' + end : '—');
