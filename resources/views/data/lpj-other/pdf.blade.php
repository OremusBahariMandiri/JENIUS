...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ── TTD ── */
        .ttd-table { width: 100%; border-collapse: collapse; margin-top: 8px; table-layout: fixed; }
        .ttd-table td {
            border: 1px solid #000;
            vertical-align: top;
            padding: 5px 8px;
...
@php
    ...
    foreach ($lpj->kasbons as $lpjKasbon) {
        ...
        foreach ($kasbon->items as $kasbonItem) {
            ...
            $cat         = optional(optional($kasbonItem->joOtherItem)->invoice)->invoice_ctg ?? 'Uncategorized';
            $invoiceTyp  = optional(optional($kasbonItem->joOtherItem)->invoice)->invoice_typ ?? $kasbonItem->id_kasbon_other_item;
...
<tbody>
    <tr>
        ...
        <td><strong>OBM-FIN-FRM-05</strong></td>
    </tr>
    <tr>
        <td>Tipe Job :</td>
        <td>Other</td>
        ...
        <td>
            @foreach($lpj->kasbons as $lpjKasbon)
                @if($lpjKasbon->kasbonOther)
                    {{ $lpjKasbon->kasbonOther->id_kasbon_other }}@if(!$loop->last), @endif
                @endif
            @endforeach
        </td>
    </tr>
