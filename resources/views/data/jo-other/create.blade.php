    ...
    <div class="container-fluid joOtherCreatePage">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form action="{{ route('jo-other.store') }}" method="POST" id="joOtherForm">
                    @csrf
                                    ...
                                    <select name="id_md_other" id="id_md_other"
                                        ...
                                        @foreach ($others as $other)
                                            <option value="{{ $other->id_md_other }}"
                                                {{ old('id_md_other') == $other->id_md_other ? 'selected' : '' }}>
                                                {{ $other->other }}
                                                @if ($other->code)
                                                    ({{ $other->code }})
                                                @endif
                    ...
                    <div class="d-flex gap-2 mb-5">
                        <button type="submit" class="btn btn-success btn-lg">
                            <i class="fas fa-save me-2"></i>Save JO Other
                        </button>
                        <a href="{{ route('jo-other.index') }}" class="btn btn-secondary btn-lg">
