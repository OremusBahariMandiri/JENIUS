...
@section('title', 'Kasbon General Data')
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header text-black d-flex justify-content-between align-items-center"
                        ...
                        <span class="fw-bold"><i class="fas fa-money-bill-wave me-2"></i>Kasbon General Data</span>
                        <div>
        ...
        $(document).ready(function () {
            ...
            if (hasData) {
                $('#kasbonGenTable').DataTable({
                    ...
                    language: { search: 'Search:', emptyTable: 'No Kasbon General data available' },
                    drawCallback: function (settings) {
                        var api = this.api(), startIndex = api.page.info().start;
            ...
            $('#filterModal').on('shown.bs.modal', function () {
                $('.select2-filter').each(function () {
                    if (!$(this).hasClass('select2-hidden-accessible')) {
                        $(this).select2({ theme: 'bootstrap-5', dropdownParent: $('#filterModal'), placeholder: $(this).data('placeholder') || '-- Select --', allowClear: true, width: '100%' });
                    }
                });
            });
