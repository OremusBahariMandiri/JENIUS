                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title"
                                    ...
                                    placeholder="JO contract title" required>
                                @error('title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="d-flex gap-3 align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="global_kurs_usd" id="global_kurs_usd"
                                            ...
                                            value="17600" placeholder="17,600.00" style="min-width: 130px;" required>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    <script>
        ...
        // Attach event listeners to item - FIXED CALCULATION LOGIC
        function attachItemEventListeners(row) {
            ...
            function calculateSellingPrice() {
                ...
                // Logic: Jika IDR diisi (> 0), gunakan IDR. Jika tidak, gunakan USD * Kurs
                if (idrValue > 0) {
        ...
        // Global kurs change handler - UPDATED
        document.getElementById('global_kurs_usd').addEventListener('input', function() {
            ...
            allRows.forEach(row => {
                ...
                // Recalculate harga jual based on current input
                if (idrValue > 0) {
                    sellingPrice.value = idrValue.toFixed(2);
                } else if (usdValue > 0) {
                    sellingPrice.value = (usdValue * kursRate).toFixed(2);
