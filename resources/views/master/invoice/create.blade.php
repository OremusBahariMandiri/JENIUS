            ...
            <div class="col-lg-12">
                <div class="card shadow">
                    <div class="card-header text-black d-flex justify-content-between align-items-center"
                        ...
                        <span class="fw-bold"><i class="fas fa-plus-circle me-2"></i>Add New Invoice</span>
                                ...
                                <div class="col-lg-12">
                                            ...
                                            @foreach ($joCtgOptions as $value => $label)
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="jo_ctg"
                                                        ...
                                                        {{ old('jo_ctg', 'contract') === $value ? 'checked' : '' }}
                                                        required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="invoice_ctg"
                                            ...
                                            value="{{ old('invoice_ctg') }}" list="categoryList" required>
                                        @error('invoice_ctg')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="invoice_typ"
                                            ...
                                            value="{{ old('invoice_typ') }}" list="typeList" required>
                                        @error('invoice_typ')
                                            <div class="invalid-feedback">
                                                <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="note" class="form-control @error('note') is-invalid @enderror" rows="5">{{ old('note') }}</textarea>
                                        @error('note')
                                            <div class="invalid-feedback">
                                                <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                            </div>
