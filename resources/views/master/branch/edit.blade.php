        ...
        <div class="col-lg-10 mx-auto">
            <div class="card shadow">
                <div class="card-header text-black d-flex justify-content-between align-items-center" style="background-color: #d1fae5">
                    <span class="fw-bold"><i class="fas fa-edit me-2"></i>Edit Branch</span>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('branch.update', $branch->id_md_branch) }}" method="POST" id="branchForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="skt_branch"
                                           ...
                                           value="{{ old('skt_branch', $branch->skt_branch) }}">
                                    @error('skt_branch')
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_branch"
                                           ...
                                           value="{{ old('nama_branch', $branch->nama_branch) }}" required>
                                    @error('nama_branch')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="area"
                                           ...
                                           value="{{ old('area', $branch->area) }}" list="areaList">
                                    @error('area')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="no_telepon"
                                           ...
                                           value="{{ old('no_telepon', $branch->no_telepon) }}">
                                    @error('no_telepon')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="alamat" rows="2"
                                              class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat', $branch->alamat) }}</textarea>
                                    @error('alamat')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="note" rows="3"
                                              class="form-control @error('note') is-invalid @enderror">{{ old('note', $branch->note) }}</textarea>
                                    @error('note')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                                </div>
