        ...
        <div class="col-lg-12">
            <div class="card shadow">
                <div class="card-header text-black d-flex justify-content-between align-items-center" style="background-color: #d1fae5">
                    <span class="fw-bold"><i class="fas fa-plus-circle me-2"></i>Add New Vessel</span>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('vessel.store') }}" method="POST" id="vesselForm">
                        @csrf
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="ship_particular"
                                              ...
                                              rows="4">{{ old('ship_particular') }}</textarea>
