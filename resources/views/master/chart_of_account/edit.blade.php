        ...
        <div class="col-lg-10 mx-auto">
            <div class="card shadow">
                <div class="card-header text-black d-flex justify-content-between align-items-center" style="background-color: #d1fae5">
                    <span class="fw-bold"><i class="fas fa-edit me-2"></i>Edit Chart of Account</span>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('chart-of-account.update', $account->id_md_chart_of_account) }}" method="POST" id="coaForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('no_account', $account->no_account) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="parrent"
                                        ...
                                        <option value="{{ $parent->kode_perkiraan }}"
                                            {{ old('parrent', $account->parrent) == $parent->kode_perkiraan ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                           id="tipeAkunDisplay"
                                           class="form-control"
                                           placeholder="Otomatis dari Parent Account"
                                           readonly>
                                    <small class="text-muted">Tipe akun diambil dari Parent Account</small>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select name="type" class="form-select @error('type') is-invalid @enderror">
                                        ...
                                        <option value="{{ $value }}"
                                            {{ old('type', $account->type) == $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select name="payment_type" class="form-select @error('payment_type') is-invalid @enderror">
                                        ...
                                        <option value="{{ $value }}"
                                            {{ old('payment_type', $account->payment_type) == $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                        @endforeach
                                    </select>
...
$(document).ready(function() {
    ...
    // Trigger saat load untuk tampilkan tipe akun existing
