        ...
        <div class="col-lg-12">
            <div class="card shadow">
                <div class="card-header text-black d-flex justify-content-between align-items-center" style="background-color: #d1fae5">
                    <span class="fw-bold"><i class="fas fa-edit me-2"></i>Edit Contract</span>
                            ...
                            <div class="col-lg-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('no_contract', $contract->no_contract) }}"
                                                   required>
                                            @error('no_contract')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('contract', $contract->contract) }}"
                                                   required>
                                            @error('contract')
                                            <div class="invalid-feedback">
                                                <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="id_md_cust"
                                        ...
                                        <option value="{{ $customer->id_md_cust }}"
                                                {{ old('id_md_cust', $contract->id_md_cust) == $customer->id_md_cust ? 'selected' : '' }}>
                                            {{ $customer->customer }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('expenditure') ? number_format(old('expenditure'), 2, ',', '.') : number_format($contract->expenditure, 2, ',', '.') }}"
                                               required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date"
                                                   ...
                                                   value="{{ old('date_start', $contract->date_start->format('Y-m-d')) }}"
                                                   required>
                                            @error('date_start')
                                            <div class="invalid-feedback">
                                                <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date"
                                                   ...
                                                   value="{{ old('date_end', $contract->date_end->format('Y-m-d')) }}"
                                                   required>
                                            @error('date_end')
                                            <div class="invalid-feedback">
                                                <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="note"
                                              ...
                                              rows="3">{{ old('note', $contract->note) }}</textarea>
                                    @error('note')
                                    <div class="invalid-feedback">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row text-sm">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <small><i class="fas fa-calendar-plus me-1"></i>{{ $contract->created_at->format('d M Y, H:i') }}</small>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <small class="text-muted">Last Updated:</small><br>
                                        <small><i class="fas fa-calendar-check me-1"></i>{{ $contract->updated_at->format('d M Y, H:i') }}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
