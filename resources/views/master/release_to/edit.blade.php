        ...
        <div class="col-lg-10 mx-auto">
            <div class="card shadow">
                <div class="card-header text-black d-flex justify-content-between align-items-center" style="background-color: #d1fae5">
                    <span class="fw-bold"><i class="fas fa-edit me-2"></i>Edit Release To</span>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('release_to.update', $release->id_md_release) }}" method="POST" id="releaseForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_release"
                                           ...
                                           value="{{ old('nama_release', $release->nama_release) }}" required>
                                    @error('nama_release')
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tujuan"
                                           ...
                                           value="{{ old('tujuan', $release->tujuan) }}" list="tujuanList">
                                    @error('tujuan')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="rekening"
                                           ...
                                           value="{{ old('rekening', $release->rekening) }}">
                                    @error('rekening')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="no_telepon"
                                           ...
                                           value="{{ old('no_telepon', $release->no_telepon) }}">
                                    @error('no_telepon')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="alamat" rows="2"
                                              class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat', $release->alamat) }}</textarea>
                                    @error('alamat')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="note" rows="3"
                                              class="form-control @error('note') is-invalid @enderror">{{ old('note', $release->note) }}</textarea>
                                    @error('note')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                                </div>
