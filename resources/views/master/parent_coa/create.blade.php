...
@section('title', 'Add Parent Chart of Account')
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card shadow">
                <div class="card-header text-black d-flex justify-content-between align-items-center" style="background-color: #d1fae5">
                    <span class="fw-bold"><i class="fas fa-plus-circle me-2"></i>Add New Parent COA</span>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('parent-coa.store') }}" method="POST" id="parentCoaForm">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_md_cost_type"
                                ...
                                <option value="{{ $costType->id_md_cost_type }}"
                                    {{ old('id_md_cost_type') == $costType->id_md_cost_type ? 'selected' : '' }}>
                                    {{ $costType->name }}
                                </option>
                                @endforeach
                            </select>
...
$(document).ready(function() {
    $('select[name="id_md_cost_type"]').focus();
});
</script>
@endpush