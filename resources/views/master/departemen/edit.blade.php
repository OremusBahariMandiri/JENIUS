        ...
        <div class="col-lg-8 mx-auto">
            <div class="card shadow">
                <div class="card-header text-black d-flex justify-content-between align-items-center" style="background-color: #d1fae5">
                    <span class="fw-bold"><i class="fas fa-edit me-2"></i>Edit Department</span>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('departemen.update', $departemen->id_md_dep) }}" method="POST" id="departemenForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="skt_dep"
                                           ...
                                           value="{{ old('skt_dep', $departemen->skt_dep) }}">
                                    @error('skt_dep')
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_dep"
                                           ...
                                           value="{{ old('nama_dep', $departemen->nama_dep) }}" required>
                                    @error('nama_dep')
                                    <div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>{{ $message }}</div>
                                    @enderror
                                </div>
